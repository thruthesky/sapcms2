...
<div id="page-header">
    <ul id="main-menu">
        ...
        <li class='link sub-menu news' route="postList" post_id="wooreeedu"><span class="sprite news"></span><div class='label'>조기유학</div></li>
		<li class='link sub-menu jobs' route="postList" post_id="wooreeedu_gallery"><span class="sprite jobs"></span><div class='label'>사진 갤러리</div></li>

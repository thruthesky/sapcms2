		...
		<div class='sub-menu'>
			<div class='inner clearfix'>
				...
				?>
					...
					<div class='inner'>
						<div class='item fake'><div class='banner'><img src='/theme/han/img/menu_photo_5.jpg'/></div><div class='title text-center'>화상 콜센터 단합대회</div></div><div class='item'>
						...
						<div class='banner'><img src='/theme/han/img/menu_photo_1.jpg'/></div><div class='title text-center'>화상 콜센터 팝송 노래</div></div>
					</div>
				</div>
					...
					<table cellpadding=0 cellspacing=0>
						<tr valign='top'>
							...
							<td width='16.67%'>
								<div class='item'>
									<ul>
										<li><a href="/gallery/2">기초 영어 회화</a></li>
										<li><a href="/gallery/3">비지니스 영어</a></li>
										<li><a href="/gallery/4">인터뷰 영어</a></li>
										<li><a href="/gallery/5">어린이 영어</a></li>
...
<div class="front-top-banner">
	<div class='arrow' direction='left'>
		<img src="/theme/han/img/top_arrow_left.png"/>
	</div>
	<div class='arrow' direction='right'>
		<img src="/theme/han/img/top_arrow_right.png"/>
	</div>
	<div class='inner'>

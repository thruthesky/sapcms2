...
<div class='page-content top'>
	<a class='left-wing ve' href='<?php echo $url_ve ?>'><img src="/theme/han/img/left_wing_ve.png"></a>
	<a class='left-wing team-viewer' href='/theme/teamviewer.exe' download><img src="/theme/han/img/left_wing_team_viewer.png"></a>
	<a class='left-wing test' href='http://han.begin.kr/solution' target="_blank"><img src="/theme/han/img/class/ve_test.jpg"></a>
...
<iframe src="http://han.begin.kr/iframe_login.php?id=<?php echo login('id')?>&classid=solution&page=teacher_list" width="100%" height="2400" style="border:0; box-sizing:border-box;"></iframe>

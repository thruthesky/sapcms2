...
<div class='page-content top'>
	<a class='left-wing ve' href='/ve?page=solution'><img src="/theme/nolja/img/left_wing_ve.png"></a>
	<a class='left-wing team-viewer' href='/theme/teamviewer.exe' download><img src="/theme/nolja/img/left_wing_team_viewer.png"></a>
	<a class='left-wing test' href='http://nolja.begin.kr/solution' target="_blank"><img src="/theme/nolja/img/class/ve_test.jpg"></a>
	<div class='grid first'>
		<div class='a'>
			<a href="http://pineseg.com/pinesjr/event_camp.html" target="_blank"><img class='front-banner' src="/theme/nolja/img/class/main-banner-left.jpg"></a>
		...
		<div class='b'>
			<div class='grid second'>
				<a class='front-banner' href='http://www.kindertimes.co.kr/'><img src="/theme/nolja/img/class/smallBanner1.png"></a><a class='front-banner'  href='http://www.kidstimes.net/'>
				<img src="/theme/nolja/img/class/smallBanner2.png"></a><a class='front-banner'  href='http://www.teentimes.org/'>
				<img src="/theme/nolja/img/class/smallBanner3.png"></a>
...
<iframe src="http://nolja.begin.kr/iframe_login.php?id=<?php echo login('id')?>&classid=solution&page=teacher_list" width="100%" height="2400" style="border:0; box-sizing:border-box;"></iframe>

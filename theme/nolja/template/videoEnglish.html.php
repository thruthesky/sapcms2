...
<div class='temp-page videoEnglish'>
	<div class='menu'>
		...
		지난 수업</a><a href="<?php echo $url_ve?>" target=_blank>강의실 입장</a>
	</div>
	<iframe src="http://nolja.begin.kr/iframe_login.php?id=<?php echo login('id')?>&classid=solution&page=<?php echo $page?>" width="100%" height="2600" style="border:0; box-sizing:border-box;"></iframe>

...
<div id="header-top">
	<div class='inner'>
		<a href="/"><img class='logo' src="/theme/nolja/img/full_logo.png"/></a>
		...
		<div class='sub-menu'>
			<div class='inner clearfix'>
				...
				?>
					...
					<div class='inner'>
						<img class='front-fake-featured' style='width:100%;opacity:0;' src='/theme/nolja/img/top_banner_featured_fake.png'>
						<div class='item fake'><div class='banner'><img src='/theme/nolja/img/menu_photo_5.jpg'/></div><div class='title text-center'>화상 콜센터 영어 수업</div></div><div class='item'><!--this is a fake banner 화상 콜센터 단합대회-->
						<div class='banner'><img src='/theme/nolja/img/menu_photo_1.jpg'/></div><div class='title text-center'>선생님 노래자랑</div></div><div class='item'>
						<div class='banner'><img src='/theme/nolja/img/menu_photo_2.jpg'/></div><div class='title text-center'>화상 콜센터 바다 여행</div></div><div class='item'>
						<div class='banner'><img src='/theme/nolja/img/menu_photo_4.jpg'/></div><div class='title text-center'>화상 콜센터 시상식</div></div><div class='item'>
						<div class='banner'><img src='/theme/nolja/img/menu_photo_3.jpg'/></div><div class='title text-center'>화상 콜센터 파티</div></div><div class='item'>
						<div class='banner'><img src='/theme/nolja/img/menu_photo_5.jpg'/></div><div class='title text-center'>화상 콜센터 영어 수업</div></div><div class='item fake'>
						<div class='banner'><img src='/theme/nolja/img/menu_photo_1.jpg'/></div><div class='title text-center'>선생님 노래자랑</div></div><!--this is a fake banner  화상 콜센터 팝송 노래-->
					</div>
				</div>
...
if( !empty( $variables['page'] )  ){
	...
	$url = "/theme/nolja/img/header_".$page .".jpg";
	//$url = "/theme/nolja/img/header_text.png";
	//if( file_exists( $url ) ){
	?>
...
<div class="front-top-banner">
	<div class='arrow' direction='left'>
		<img class='original' src="/theme/nolja/img/top_arrow_left.png"/>
		<img class='ie8' src="/theme/nolja/img/ie8/top_arrow_left.png"/>
	</div>
	<div class='arrow' direction='right'>
		<img class='original' src="/theme/nolja/img/top_arrow_right.png"/>
		<img class='ie8' src="/theme/nolja/img/ie8/top_arrow_right.png"/>
	</div>
	<div class='inner'>
		<img class='front-fake' style='width:100%;opacity:0;' src='/theme/nolja/img/top_banner_fake.png'>
		<div class='banner-wrapper five'>
			<img class='banner fake' src='/theme/nolja/img/banner_5.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
			...
			<img class='banner' src='/theme/nolja/img/banner_1.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
                        <div class='text top'>방문과외전문 + 화상영어</div><br>
			...
			<img class='banner' src='/theme/nolja/img/banner_2.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
						<img class='fake-image' src='/theme/nolja/img/banner_fake_image_perfect_sides.png'/>
			...
			<img class='banner' src='/theme/nolja/img/banner_3.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
			...
			<img class='banner' src='/theme/nolja/img/banner_4.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
			...
			<img class='banner' src='/theme/nolja/img/banner_5.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
						<div class='text top'>2015년 주니어 겨울 영어 캠프</div><br>
			...
			<img class='banner fake' src='/theme/nolja/img/banner_1.jpg'/>
			<div class='text-info'>
				<div class='inner'>
					<div class='wrapper'>
                        <div class='text top'>방문과외전문 + 화상영어</div><br>

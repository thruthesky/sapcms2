...
function postHoverTitleImage( $posts, $width = 300, $height = 300, $title_length = 30 ){
	...
	foreach( $posts as $post ){
		...
		//$thumbnail_label = "<img src='/theme/nolja/img/tempThumbnailLabel.png'/>";
		$thumbnail_label = "<img src='/theme/nolja/favicon.ico'/>";
		$url = $post->url();
...
function postFeaturedSlider( $posts, $width = 200, $height = 150, $subject_length = 20 ){
	...
	if( !empty( $posts ) ) {
		...
		echo "<div class='item fake'><img src='theme/nolja/img/popsong_5.jpg'/><div class='title text-center'>Title 5</div></div>";
				
		for( $i= 1; $i <= 5; $i++ ){
			$url = "theme/nolja/img/popsong_$i.jpg";
			echo "<div class='item'><img src='$url'/><div class='title text-center'>Title $i</div></div>";
		}
			echo "<div class='item fake'><img src='theme/nolja/img/popsong_1.jpg'/><div class='title text-center'>Title 1</div></div>";

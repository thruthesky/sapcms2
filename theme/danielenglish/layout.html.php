...
$url_ve = "http://danielenglish.begin.kr/iframe_login.php?id=".login('id')."&classid=solution&page=solution";
?>
<html>
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no" />
    <link type='text/css' href='/theme/danielenglish/css/base.css' rel='stylesheet' />
    <link type='text/css' href='/theme/danielenglish/css/layout.css' rel='stylesheet' />
    <link type='text/css' href='/theme/danielenglish/css/component.css' rel='stylesheet' />
    <link type='text/css' href='/theme/danielenglish/css/component.grid.css' rel='stylesheet' />
    <link type='text/css' href='/theme/danielenglish/css/wooree-grid3.css' rel='stylesheet' />
    <link rel="icon" type="image/ico" href="/theme/danielenglish/favicon.ico?v=3"/>
</head>
<body>
<div id="layout">	
...
<?php add_javascript('danielenglish.js'); ?>
<?php widget('timezone'); ?>
</body>
</html>

...
<div class='temp-page videoEnglish'>
	...
	<iframe src="http://danielenglish.begin.kr/iframe_login.php?id=<?php echo login('id')?>&classid=solution&page=<?php echo $page?>" width="100%" height="2600" style="border:0; box-sizing:border-box;"></iframe>

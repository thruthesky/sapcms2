	...
	<div class='inner'>
		<div class='item talk'>
			<a href='/ve?page=solution' class='image'>
				<img class='default' src='/theme/danielchina/img/book.png'/>
				<img class='active' src='/theme/danielchina/img/book-active.png'/>
			</a>
			<div class='label'>강의실입장</div>
		</div>
		<div class='item grad'>
			<a href='/ve?page=reservation' class='image'>
				<img class='default' src='/theme/danielchina/img/grad.png'/>
				<img class='active' src='/theme/danielchina/img/grad-active.png'/>
			</a>
			<div class='label'>예약된 수업</div>
		</div>
		<div class='item date'>		
			<a href='/ve?page=past' class='image'>
				<img class='default' src='/theme/danielchina/img/camp.png'/>
				<img class='active' src='/theme/danielchina/img/camp-active.png'/>
			</a>
			<div class='label'>지난 수업</div>
		</div>
		<div class='item price'>
			<a href='/camp/3' class='image'>
				<img class='default' src='/theme/danielchina/img/price.png'/>
				<img class='active' src='/theme/danielchina/img/price-active.png'/>
			</a>
			<div class='label'>수업 비용 안내</div>
		</div>
		<div class='item blog'>
			<a href='/post/list?id=qna' class='image'>
				<img class='default' src='/theme/danielchina/img/blog.png'/>
				<img class='active' src='/theme/danielchina/img/blog-active.png'/>
			</a>
			<div class='label'>질문답변</div>
		</div>
		<div class='item gallery'>
			<a href='/post/list?id=story' class='image'>
				<img class='default' src='/theme/danielchina/img/gallery.png'/>
				<img class='active' src='/theme/danielchina/img/gallery-active.png'/>
			</a>

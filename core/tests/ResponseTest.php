...
class ResponseTest extends PHPUnit_Framework_TestCase
{
    public function test_css()
    {
        ...
        $this->assertTrue( add_css('/core/module/user/css/abc.css') == $url_site . 'core/module/user/css/abc.css' );
    ...
    {
        $url_site = sysconfig(URL_SITE);
        $this->assertTrue( add_javascript('/core/module/user/js/abc.js') == $url_site . 'core/module/user/js/abc.js' );
